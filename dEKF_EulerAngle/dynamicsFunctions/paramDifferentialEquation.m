function dwdt = rigidBodyDifferentialEquationImplicit(t, x, p, f_Bo_t, mu_Bo_t, f_Bc_t, mu_Bc_t, useInvDyn)
...
domega_B = - S(omega_B) * (I_B * omega_B) +  (+mu_B_t_o - mu_B_t_c) + (K_B*phi);
