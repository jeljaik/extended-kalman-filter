...
kalmanQParams{2} = 0.1*[0.5,    0.5,   0.1,    0.1,    1.0,    0.0075]; 
kalmanQParams{3} = 0.1*[4.0,    10.50,   5.0,    8.0,    0.05,    0.75]; 

% measurement model variances
% param ordering : [f_R,    mu_R,   a_R,    omega_R,    skin_R]
kalmanRParams{1} = [1.5,    2.75,   1.25,   4.5,        2.575];    
kalmanRParams{2} = 1.0*[0.2758,    0.00812,   0.008,   0.0018,       10.2235];
kalmanRParams{3} = 2.5*[1.5,    2.75,   0.55,   0.5,        2.575];
