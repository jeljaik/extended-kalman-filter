function dxdt = processImplicitODE_dualState(t, x, p, f_Bo_t, mu_Bo_t, f_Bc_t, mu_Bc_t, useInvDyn)
% PROCESSIMPLICITODE_DUALSTATE Computes the rigid body differential equations.
%   PROCESSIMPLICITODE_DUALSTATE(t, x, p, tc, f_B1_tc, mu_B1_tc,
%   f_B2_tc, mu_B2_tc).
%
%       dphi   = T_phi^-1 * omega
%
...
df_B_c   =  zeros(3,1);  % random walk
dmu_B_c  =  zeros(3,1);  % random walk

dphi = Tomega_dphi(phi)\omega_B;
dK = zeros(9,1); % random walk
