function [model,tMax,leg_ft,foot_ft,skin,inertial,transforms] = modelSensorParams_footWithoutlegFT_comprehensive(whichLeg,whichSkin,numberOfExperiment,t_max,measurementType,dataset)
