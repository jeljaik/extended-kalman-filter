...
% Modified by Jorhabib Eljaik September 5 2014
...
model_no_quat.I  = model.I
model_no_quat.m  = model.m;
model_no_quat.u  = model.u;
model_no_quat.v  = 1;
model_no_quat.x0 = model.x0(1:12,1);
model_no_quat.dt = model.dt;
...
[t,   x] = integrateForwardDynamics_Quaternion(model.x0(1:12,1), model, 0:dt:T);
