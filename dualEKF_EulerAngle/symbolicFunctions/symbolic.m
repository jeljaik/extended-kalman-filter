...
% matlabFunction(df_dx,'file','./symbolicFunctions/rigidBodyDynamicsDerivatives','vars',[x; w; dI; m; g; gRot]);
% matlabFunction(dh_dx,'file','./symbolicFunctions/rigidBodyOutputsDerivatives','vars',[x; w; dI; m; g; gRot]);
% 
% matlabFunction(dk_dw,'file','./symbolicFunctions/paramDynamicsDerivatives','vars',[x; w; dI; m; g; gRot]);
% matlabFunction(dc_dw,'file','./symbolicFunctions/paramOutputsDerivatives','vars',[x; w; dI; m; g; gRot]);