function [model,tMax,leg_ft,foot_ft,inertial,transforms] = modelSensorParams_completeLeg(whichLeg,whichSkin,numberOfExperiment,t_max)
...
tMax = min([leg_ft.t(end),foot_ft.t(end),inertial.t(end),t_max]);
