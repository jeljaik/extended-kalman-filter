...
%% Params
 ...
 [model,tMax,leg_ft,foot_ft,inertial,transforms] = modelSensorParams_completeLeg(whichLeg,whichSkin,numberOfExperiment,t_max);
...
yCalib = [a_calib;omega_calib;fo_calib;muo_calib;fc_calib;muc_calib]';
