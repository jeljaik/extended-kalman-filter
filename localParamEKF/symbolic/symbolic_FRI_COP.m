...
F_cop_bar  = F_cop(muc_x_bar, muc_y_bar,fc_z_bar);
F_cop_mean = F_cop_mean(muc_x_mean, muc_y_mean,fc_z_mean);

F_fri_bar = F_fri(muo_x_bar, muo_y_bar,fo_z_bar);
F_fri_mean = F_fri(muo_x_mean, muo_y_mean,fo_z_mean);

J_cop_bar = jacobian(F_cop_bar,[muc_x_bar, muc_y_bar,fc_z_bar]');
J_cop_mean = jacobian(F_cop_mean,[muc_x_mean, muc_y_mean,fc_z_mean]');

J_fri_bar = jacobian(F_fri_bar,[muo_x_bar, muo_y_bar,fo_z_bar]');
J_fri_mean = jacobian(F_fri_mean,[muo_x_mean, muo_y_mean,fo_z_mean]');


pcop_expect_at_Bar = J_cop_bar*[muc_x_mean, muc_y_mean,fc_z_mean]' + J_cop_bar*[muc_x_bar, muc_y_bar,fc_z_bar]' + F_bar;
...
pfri_expect_at_Bar = J_fri_bar*[muo_x_mean, muo_y_mean,fo_z_mean]' + J_fri_bar*[muo_x_bar, muo_y_bar,fo_z_bar]' + F_bar;
...
matlabFunction(pfri_expect_at_Mean,pfri_cov_at_Mean,'file','fri_meanLinearisation','vars',[[muc_x_mean, muc_y_mean,fc_z_mean]';...
